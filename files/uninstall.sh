...
echo ""
echo "#########################################################"
echo "## -> KITANAR SCRIPT SOFTWARE FREE FOR ALL             ##"
echo "## -> Author : N A X O L Y Z Z                         ##"
echo "## -> Email : imskinz6@gmail.com                       ##"
echo "## -> Wa    : 087724166682                             ##"
echo "## -> (c) 2023-2025, KITANAR SCRIPT Software           ##"
echo "#########################################################"
echo ""
