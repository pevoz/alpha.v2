...
echo -e " » Proses Pengeceian IP Address Anda !!"
echo -e "${purple}----------------------------------------------------------${NC}"
echo -e " » BY ${green}KITANAR SCRIPT ${NC}${YELLOW}(${NC}${green}V 3.5${NC}${YELLOW})${NC}"
...
echo ""
echo "" | tee -a log-install.txt
echo "Semuanya Berjalan Ok...Terimakasih Telah menggunakan KITANAR SCRIPT!!"
sleep 1
