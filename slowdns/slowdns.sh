...
wget -q -O /etc/slowdns/server.key "https://raw.githubusercontent.com/pevoz/alpha.v2/refs/heads/main/slowdns/server.key"
wget -q -O /etc/slowdns/server.pub "https://raw.githubusercontent.com/pevoz/alpha.v2/refs/heads/main/slowdns/server.pub"
wget -q -O /etc/slowdns/sldns-server "https://raw.githubusercontent.com/pevoz/alpha.v2/refs/heads/main/slowdns/sldns-server"
wget -q -O /etc/slowdns/sldns-client "https://raw.githubusercontent.com/pevoz/alpha.v2/refs/heads/main/slowdns/sldns-client"
cd
...
[Unit]
Description=Client SlowDNS By Naxolyzz
...
[Unit]
Description=Server SlowDNS By Naxolyzz
Documentation=https://nekopoi.care
After=network.target nss-lookup.target
